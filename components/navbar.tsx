    ...
    <section className="lg:h-[72px] h-[102px] bg-white shadow-md flex fixed ps-[24px] w-full top-0 flex-col z-50">
      <div className="flex justify-between lg:justify-normal w-full grow">
        <div className="lg:hidden flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 hover:cursor-pointer">
        ...
        <div className="ms-auto lg:flex hidden">
          <div className="flex justify-center items-center text-[#787878] border-x-[1px] w-[328px] px-7 font-semibold me-6 hover:text-[#e21c23] hover:cursor-pointer">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 ms-[26px]">
              <path fillRule="evenodd" d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" />
            </svg>
          </div>
          <div className="leading-[70px]">
            <Link className="text-sm me-6 min-w-[140px] h-[48px] inline-block text-center rounded-[50px] leading-[46px] font-light border-[1px] border-[#e21c23] text-[#e21c23]"
            href={'/register'} >
              Register
            </Link>
          </div>
          <div className="leading-[70px]">
            <Link className="text-sm me-6 min-w-[140px] h-[48px] inline-block text-center rounded-[50px] leading-[46px] font-light border-[1px] bg-[#e21c23] text-white hover:bg-[#e21c23]/80"
            href={'/login'} >
              Login
            </Link>
          </div>
      ...
      <div className={"fixed h-full bg-[rgba(0,0,0,0.4)] z-50 left-0 flex" + (isSideNavOpen ? ' w-full' : ' w-0')}>
        <div className="w-full" onClick={()=>setIsSideNavOpen(false)}>
        </div>
        <div className={"fixed h-full bg-white z-50 right-0 transition-all duration-300" + (isSideNavOpen ? ' w-[300px] py-8 px-6' : ' w-0')} >
          {isSideNavOpen ?
            <>
              <div className="hover:cursor-pointer w-fit" onClick={() => setIsSideNavOpen(false)}>
              ...
              <div className="leading-[70px]">
                <Link className="text-sm w-full me-6 min-w-[140px] h-[48px] inline-block text-center rounded-[50px] leading-[46px] font-light border-[1px] border-[#e21c23] text-[#e21c23]"
                  onClick={() => setIsSideNavOpen(false)} href={'/register'} >
                  Register
                </Link>
              </div>
              <div className="leading-[70px]">
                <Link className="text-sm w-full me-6 min-w-[140px] h-[48px] inline-block text-center rounded-[50px] leading-[46px] font-light border-[1px] bg-[#e21c23] text-white hover:bg-[#e21c23]/80"
                  onClick={() => setIsSideNavOpen(false)} href={'/login'} >
                  Login
                </Link>
              </div>
            </>
