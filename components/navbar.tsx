...
function NavBar() {
  return (
    <section className="lg:h-[72px] h-[102px] bg-white shadow-md flex fixed ps-[24px] w-full top-0 flex-col">
      <div className="flex justify-between lg:justify-normal w-full grow">
        ...
        <div className="ms-auto lg:flex hidden">
          ...
          <div className="leading-[70px]">
            <Link className="me-6 min-w-[140px] h-[48px] inline-block text-center rounded-[50px] leading-[46px] font-light border-[1px] border-[#e21c23] text-[#e21c23]"
            href={'/register'} >
              Register
            </Link>
          </div>
          <div className="leading-[70px]">
            <Link className="me-6 min-w-[140px] h-[48px] inline-block text-center rounded-[50px] leading-[46px] font-light border-[1px] bg-[#e21c23] text-white hover:bg-[#e21c23]/80"
            href={'/login'} >
              Login
            </Link>
          </div>
