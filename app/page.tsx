      ...
      <div className="mt-10 mx-4 ">
        <div className="container max-w-[1200px] mx-auto flex flex-col lg:flex-row-reverse justify-center">
          <div className="flex flex-col justify-center">
            <h1 className="text-center text-3xl font-semibold mb-6 lg:text-left">
              Download on
            </h1>
            <div className="flex gap-5 justify-center mb-8">
              <Image
                className="w-auto lg:min-w-[170px]"
                src={"/google-play.png"}
                alt="google-play"
                width={100}
                height={100}
          ...
          <Image
            className="w-auto m-auto min-w-[260px] lg:min-w-[400px] lg:mx-0"
